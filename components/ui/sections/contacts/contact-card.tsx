...
export const ContactCard = ({ t }: { t: TFn }) => {
  ...
  return (
    <div className="mt-6 grid gap-4 md:grid-cols-12">
      <div className="md:col-span-7 rounded-[24px] md:rounded-[32px] border border-white/10 bg-white/5 p-5 md:p-6 backdrop-blur-2xl">
        ...
        <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center">
          <a
            href={href}
            className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-2xl bg-emerald-200/90 px-4 py-3 text-sm font-semibold text-[#061415] transition hover:bg-emerald-200"
          >
            {t("contacts.card.cta")}

...
export function HeroSection({ t }: { t: (k: string) => string }) {
  return (
    <LandingSection id="hero" className="pt-10 md:pt-16">
      <div className="rounded-4xl border border-white/5 bg-white/5 p-8 backdrop-blur-xs md:p-12">
        <h1 className="text-3xl font-semibold leading-tight md:text-5xl">
          {t("hero.title")}
        </h1>
        <p className="mt-4 max-w-2xl text-white/70">{t("hero.subtitle")}</p>
        <p>
